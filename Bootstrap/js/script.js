    ...
    .click(function () {
      $.get("film.php?page=" + page, function (respon) {
        $.each(respon, function (key, value) {
          $("#film").append(
            '<div class="col d-flex justify-content-center mb-4"><div class="card shadow zoom"> <img src="https://m.media-amazon.com/images/M/MV5BMTgzMTEyOTgyOF5BMl5BanBnXkFtZTcwOTY1ODkxNw@@._V1_.jpg" class="card-img-top" alt="' +
              value.title +
